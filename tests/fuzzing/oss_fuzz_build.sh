...
compile_go_fuzzer github.com/fish98/runc/libcontainer/userns FuzzUIDMap id_map_fuzzer linux,gofuzz
compile_go_fuzzer github.com/fish98/runc/libcontainer/user FuzzUser user_fuzzer
compile_go_fuzzer github.com/fish98/runc/libcontainer/configs FuzzUnmarshalJSON configs_fuzzer
compile_go_fuzzer github.com/fish98/runc/libcontainer/system FuzzParseStat proc_fuzzer